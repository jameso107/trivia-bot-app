...
async function newPlayer(browser: Browser, code: string): Promise<Page> {
...
async function joinNewTeam(page: Page, name: string, team: string) {
...
async function joinExistingTeam(page: Page, name: string, team: string) {
...
async function advanceTo(host: Page, state: string) {
...
async function expectPlayerState(page: Page, state: string) {
